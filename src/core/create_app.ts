...
export function create_app({
	...
	const server_manifest = generate_server_manifest(manifest_data, path_to_routes, root, src, dest, dev);
...
function generate_server_manifest(
	...
	const build_dir = posixify(path.normalize(path.relative(root, dest)));
	const src_dir = posixify(path.normalize(path.relative(root, src)));
