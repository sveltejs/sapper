...
export function create_main_manifests({
	...
	const server_manifest = generate_server(manifest_data, path_to_routes, src, dest, dev);
...
function generate_server(
	...
	const build_dir = path.relative(process.cwd(), dest);
	const src_dir = path.relative(process.cwd(), src);
