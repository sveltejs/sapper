...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../Users/208311/Development/SVELTE/sapper/test/app/node_modules/css-loader/index.js!./svelte-2385599062.css", function() {
			var newContent = require("!!../../../../../../Users/208311/Development/SVELTE/sapper/test/app/node_modules/css-loader/index.js!./svelte-2385599062.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".content[svelte-2385599062] h2{font-size:1.4em;font-weight:500}.content[svelte-2385599062] pre{background-color:#f9f9f9;box-shadow:inset 1px 1px 5px rgba(0,0,0,0.05);padding:0.5em;border-radius:2px;overflow-x:auto}.content[svelte-2385599062] pre code{background-color:transparent;padding:0}.content[svelte-2385599062] ul{line-height:1.5}.content[svelte-2385599062] li{margin:0 0 0.5em 0}", ""]);
...
/* routes/blog/[slug].html generated by Svelte v1.49.1 */
...
function encapsulateStyles(node) {
	Object(__WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["s" /* setAttribute */])(node, "svelte-2385599062", "");
}

function create_main_fragment(state, component) {
	var title, text_value = state.post.title, text, text_2, text_3, h1, text_4_value = state.post.title, text_4, text_5, div, raw_value = state.post.html, text_7;
	...
	return {
		c: function create() {
			...
			text_4 = Object(__WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["j" /* createText */])(text_4_value);
		...
		l: function claim(nodes) {
			...
			text_4 = Object(__WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["g" /* claimText */])(h1_nodes, text_4_value);
		...
		m: function mount(target, anchor) {
			...
			Object(__WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["b" /* appendNode */])(div, layout._slotted.default);
		...
		p: function update(changed, state) {
			...
			if ((changed.post) && text_4_value !== (text_4_value = state.post.title)) {
...
Object(__WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["c" /* assign */])(Slug.prototype, __WEBPACK_IMPORTED_MODULE_0__Users_208311_Development_SVELTE_sapper_test_app_node_modules_svelte_shared_js__["p" /* proto */]);
